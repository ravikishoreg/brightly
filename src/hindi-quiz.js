...
class HindiQuestionGenerator {
  ...
  generateQuestion(usedQuestions = new Set()) {
    ...
    switch (this.category) {
      case 'relationships':
        questionPool = HindiQuestionGenerator.relationshipsQuestions;
        break;
      case 'numbers':
        questionPool = HindiQuestionGenerator.numbersQuestions;
        break;
      case 'basic-words':
        questionPool = HindiQuestionGenerator.basicWordsQuestions;
        break;
      case 'mixed':
        // Randomly select from all three categories
        const allCategories = [...HindiQuestionGenerator.relationshipsQuestions, ...HindiQuestionGenerator.numbersQuestions, ...HindiQuestionGenerator.basicWordsQuestions];
        questionPool = allCategories;
        break;
      default:
        // Default to mixed (all categories)
        const allCategoriesDefault = [...HindiQuestionGenerator.relationshipsQuestions, ...HindiQuestionGenerator.numbersQuestions, ...HindiQuestionGenerator.basicWordsQuestions];
